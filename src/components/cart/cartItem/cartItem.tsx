...
const CartItem: React.FC<IPizza> = ({title, description, price, img, _id, count, isPromo}) => {
    ...
    return (
        <li className="cart-item">
            <div className="cart-item__container">
                ...
                {!isPromo ? <div className="cart-item__btn-count">
                    <input type="button"
                ...
                {!isPromo ? <img className="cart-item__btn-del"
                                 src={trash}
                                 alt="delete"
                                 onClick={() => {
